...
<q-btn
    ...
    <q-drawer side="right" v-model="drawer" :width="300">
      <div>
        <q-img src="/bg_menu-masker.png" style="width:100%:height:auto;"></q-img>
        <q-list class="q-pt-none rounded-borders" style="max-width: 350px">
          <q-item clickable v-ripple>
            <q-item-section avatar>
              <q-avatar>
                <q-img src="/penguin.svg" width="35px" />
              </q-avatar>
            </q-item-section>
    ...
    <q-footer bordered :class="$q.dark.isActive ? 'bg-dark' : 'bg-dark'" style="z-index:4000">
      ...
      >
        <q-route-tab name="menu" label="menu" icon="img:/penguin_dark.svg"  to="/dashboard" />
        ...
        <q-tab name="menu" icon="img:/logo_dark.svg" @click="drawer = !drawer" class="q-px-sm"/>
      </q-tabs>
    </q-footer>
